        ...
        <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
            ...
            <section id="sessao">
            <table id="tabela-pontuacao">
            <tr>
            <th class="escritura-escolhida" colspan="2">${escrituraEscolhida}</th>
            </tr>
            <tr>
            <th class="tabela-subtitulo">Nome</th>
            <th class="tabela-subtitulo">Pontua��o</th>
            </tr>

            <c:forEach items="${requestScope.lista}" var="usu">
            <tr class="linha-tabela">
            <td class="coluna1">${usu.nome}</td>
            <td class="coluna2">${usu.pontos}</td>
            </tr>
            </c:forEach>
