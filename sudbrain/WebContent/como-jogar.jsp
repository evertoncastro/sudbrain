...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
    ...
    <nav id="menu">
    <ul>
    <li onmouseover="mudaImagem('_imagens/escrituras.png')" onmouseout="mudaImagem('_imagens/como-jogar.png')"><a href="../sudbrain/index.jsp">Home</a></li>
    <li onmouseover="mudaImagem('_imagens/sobre.png')" onmouseout="mudaImagem('_imagens/como-jogar.png')"><a href="../sudbrain/sobre.jsp">Sobre</a></li>
    <li onmouseover="mudaImagem('_imagens/como-jogar.png')" onmouseout="mudaImagem('_imagens/como-jogar.png')"><a href="../sudbrain/como-jogar.jsp">Como jogar</a></li>
    <li onmouseover="mudaImagem('_imagens/ranking.png')" onmouseout="mudaImagem('_imagens/como-jogar.png')"><a href="../sudbrain/opcoes_ranking.jsp">Ranking</a></li>
    </nav>
    ...
    <nav id="menu-links">
    <ul>
    <li><a class="links-como-jogar" href="explicacoes.html#novo" target="janela">Acessando o Formulário</a></li>
    <li><a class="links-como-jogar" href="explicacoes.html#formulario" target="janela">Criando novo usuário</a></li>
    ...
    <li><a class="links-como-jogar" href="explicacoes.html#painel-jogos" target="janela">Opções de jogo</a></li>
    ...
    <li><a class="links-como-jogar" href="explicacoes.html#auxilios" target="janela">Auxílios</a></li>
    </ul>
    </nav>
    </aside>
