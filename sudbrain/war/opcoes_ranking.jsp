...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
    ...
    <section id="sessao">
    <label id="titulo-opcoes-escrituras">Escolha o Ranking por escritura</label>
    <ul id="opcoes-escrituras">
    <a href="servletMostraRanking.do?escritura=mormon"><li id="escritura1"><span>Veja o Ranking</span></li></a>
    <a href="servletMostraRanking.do?escritura=doutrina"><li id="escritura2"><span>Veja o Ranking</span></li></a>
    <a href="servletMostraRanking.do?escritura=velho"><li id="escritura3"><span>Veja o Ranking</span></li></a>
    <a href="servletMostraRanking.do?escritura=novo"><li id="escritura4"><span>Veja o Ranking</span></li></a>
    </ul>
