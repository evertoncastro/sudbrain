...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
    ...
    <nav id="menu">
    <ul>
    <li onmouseover="mudaImagem('_imagens/escrituras.png')" onmouseout="mudaImagem('_imagens/escrituras.png')"><a href="../sudbrain/index.jsp">Home</a></li>
    <li onmouseover="mudaImagem('_imagens/sobre.png')" onmouseout="mudaImagem('_imagens/escrituras.png')"><a href="../sudbrain/sobre.jsp">Sobre</a></li>
    <li onmouseover="mudaImagem('_imagens/como-jogar.png')" onmouseout="mudaImagem('_imagens/escrituras.png')"><a href="../sudbrain/como-jogar.jsp">Como jogar</a></li>
    <li onmouseover="mudaImagem('_imagens/ranking.png')" onmouseout="mudaImagem('_imagens/escrituras.png')"><a href="../sudbrain/opcoes_ranking.jsp">Ranking</a></li>
    </nav>
    ...
    <p id="escritura">"Examinais as Escrituras, porque vós cuidais ter nelas a vida eterna, e são elas que de mim testificam".</p>
    <p id="escritura-referencia">João 5:39.</p>
